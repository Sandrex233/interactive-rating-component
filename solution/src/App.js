...
function App() {
  ...
  const Button = ({ number }) => {
    return <button
      ...
      className="btn-number bg-gray-700 h-12 w-12 rounded-full pt-1 text-gray-200 focus:bg-gray-400 transition-all duration-150">
      {number}
    </button>
  }
  ...
  return (
    <div className="wrapper">
      ...
      <div className="flex items-center justify-center">
        <p className="p-rating rounded-full bg-gray-700 text-center text-sm px-4 pt-1">
